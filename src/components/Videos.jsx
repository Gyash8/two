      ...
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} overflowY={'auto'}>
          ...
          <Text>
            ...
            ullam officia, quidem neque deleniti officiis sapiente. Alias ipsum
            sunt perferendis saepe officiis voluptate fugit commodi cumque
            sapiente. Praesentium itaque eum enim fugiat cupiditate. Corporis
            facilis explicabo commodi at esse quasi mollitia doloremque,
          </Text>
        </VStack>
      </VStack>
      <VStack alignItems={'stretch'} overflowY={'auto'} spacing={'8'} p='8' w={['full', 'xl']}>
        {
